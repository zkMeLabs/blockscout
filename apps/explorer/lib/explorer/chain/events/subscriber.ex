defmodule Explorer.Chain.Events.Subscriber do
  ...
  @allowed_broadcast_events ~w(addresses address_coin_balances address_token_balances blocks block_rewards internal_transactions last_block_number polygon_supernet_reorg_block token_transfers transactions contract_verification_result token_total_supply changed_bytecode smart_contract_was_verified)a
