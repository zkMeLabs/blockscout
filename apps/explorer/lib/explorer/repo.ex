defmodule Explorer.Repo do
  ...
  *Note:* Should always be run within a transaction as multiple inserts may occur.
  ...
  defmodule Suave do
    ...
    def init(_, opts) do
      db_url = Application.get_env(:explorer, Explorer.Repo.Suave)[:url]
      repo_conf = Application.get_env(:explorer, Explorer.Repo.Suave)
      ...
      Application.put_env(:explorer, Explorer.Repo.Suave, merged)
